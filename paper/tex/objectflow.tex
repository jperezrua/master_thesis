...
\ifcsdef{r@accv_format}{
   \begin{figure}[th]
      \centering
      \includegraphics[width=0.95\textwidth]{../images/extrapolated.png}
...
\ifcsdef{r@accv_format}{
   \begin{figure}[t]
      \centering
      \includegraphics[width=0.9\textwidth]{../images/compare2.png}
...
\ifcsdef{r@accv_format}{
   \begin{figure}[th]
      \centering
      \includegraphics[width=0.9\textwidth]{../images/psnr2.png}
...
\ifcsdef{r@accv_format}{
   \begin{figure}[bh]
      \centering
      \includegraphics[width=0.9\textwidth]{../images/videoedition.png}
   ...
   \begin{figure}[th]
      \centering
      \includegraphics[width=0.5\textwidth]{../images/videoedition.png}
      \caption{An application of the object flow for augmented reality/video edition. }
      \label{of_app}
   \end{figure}
	\setlength{\belowcaptionskip}{-10pt}
