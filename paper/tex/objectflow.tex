...
Observe that the object details are lost in comparison with the groundtruth object image (Fig. \ref{compare2}). For example, the closed eyes detail is missing in the most of the optical 
