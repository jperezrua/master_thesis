...
%Having several labeled superpixels can reduce widely or totally the necessity for user interaction in subsequent frames in %comparison with other segmentation techniques. 
% Thus, to perform object segmentation in a full video sequence, the required
