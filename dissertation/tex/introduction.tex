...
Then, a list of results and implementation details are discussed in \ref{chap:results}, and 
an approach to a couple of applications of the object flow are discussed in 
\ref{chap:apps}. Finally, some insights and remarks are commented in \ref{chap:conclusion}.
